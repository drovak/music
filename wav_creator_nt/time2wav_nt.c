...
#define MAX_INPUT_SIZE 200000000
#define MAX_OUTPUT_SIZE 20000000
...
int main(int argc, char* argv[])
{
	...
	//fprintf(stderr, "allocated input data at %p, size %ld\n", input_data, MAX_INPUT_SIZE * sizeof(float));
	...
	//fprintf(stderr, "allocated output data at %p, size %ld\n", output_data, MAX_OUTPUT_SIZE * sizeof(float));
	...
	src_data.input_frames = (cur_time/10)+PULSE_LENGTH+100;
